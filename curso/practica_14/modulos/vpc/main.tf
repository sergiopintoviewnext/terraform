resource "aws_vpc" "vpc_practica" {
  ...
  tags = {
    Name = "vpc_practica_${var.numero_practica}"
  }
}
...
resource "aws_subnet" "subnet" {
  ...
  tags = {
    Name = "subnet_practica_${var.numero_practica}"
  }
}
...
resource "aws_internet_gateway" "gw_practica" {
  vpc_id = aws_vpc.vpc_practica.id
  tags = {
    Name = "gateway_practica_${var.numero_practica}"
  }
}
...
resource "aws_route_table" "route_table_practica" {
  ...
  tags = {
    Name = "route_table_practica_${var.numero_practica}"
  }
}
